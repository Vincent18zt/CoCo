...
gramTree* create_tree(string name, int num,...) {
    ...
    if(num > 0) {
        ...
        head->line = line;
        //added by Minhe START
        int word = va_arg(valist,int);
        head->word = word;
        //added by Minhe END
        ...
        if(head->line!=-1) {
            ...
            */
            ...
            head->name == "CHAR" || head->name == "DOUBLE") {
                ...
                //cout << " <" << head->line << ">";
                //added by Minhe
                //cout << setw(30) << "<line:" << head->line << "> ";
                cout << setw(30) << head->content << " ";
            }
            cout << setw(30) << "Children: ";
            if(head->left != NULL){
              cout << head->left->word << " ";
            }
            if(head->right != NULL){
              cout << head->right->word << " ";
            }
            cout << endl;
            //}
        }
